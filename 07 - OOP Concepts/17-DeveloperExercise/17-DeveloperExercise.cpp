...
public:
	...
	void print()
	{
		...
		cout << "Deparment: " << getDepartment() << endl;
		cout << "Main Programming Langauge: " << _mainProgrammingLangauge << endl;
...
int main()
{
	...
	developer.print();
	developer.sendSMS("Hi Mr. Developer!"); // easily access sendSMS method with inheritance!
